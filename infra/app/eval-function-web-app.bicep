...
param cosmosdbSummaryContainer string
...
resource functionApp 'Microsoft.Web/sites@2022-03-01' = {
        ...
        } 
 {
         ...
         {
          name: 'COSMOSDB_SUMMARY_CONTAINER'
          value: cosmosdbSummaryContainer
        } 
         {
        ...
        {
          name: 'BATCH_ANALYZER_AGENT_ID'
          value: ''
        } 
        {
          name: 'FINAL_SUMMARIZER_AGENT_ID'
          value: ''
        } 
